...
<p align="center">
	<i>Forked from <a href="https://github.com/Larsonix/TaskbarGroupsEx-Custom">Larsonix/TaskbarGroupsEx-Custom</a></i>
</p>
...
- **10 shortcuts Default Value for new group and 50 shortcuts Maximum Width** - Increased the Default Value to 10 and expanded the shortcut Maximum Width to 50

  <img width="112" height="33" alt="image" src="https://github.com/user-attachments/assets/2d6ab34e-4edd-4024-b4ff-f10efb6befd9" /> <img width="122" height="52" alt="image" src="https://github.com/user-attachments/assets/cf0f8eb2-ecec-456f-bdd0-bfb6be080175" />
...
- **Red title text expansion** - Expanded the number of characters to show the entire text
  ...
  <img width="368" height="60" alt="image" src="https://github.com/user-attachments/assets/3abca13d-9227-495c-b470-7b28e4853a49" /> <img width="367" height="59" alt="image" src="https://github.com/user-attachments/assets/4daca27b-097e-4d83-9f26-9723d395cfdb" />
- **UI** - Some other little optimization and re-organization
